        ...
        <footer className="bg-gray-900 text-white pt-12 pb-4 px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <div>
                    ...
                    <h3 className="font-bold mb-4 underline decoration-2 underline-offset-4 decoration-[#ffb400]">JAKEM Business Solutions</h3>
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li><Link href="/" className="text-gray-200 font-medium hover:text-[#ffb400] duration-500 transition">Home</Link></li>
                        <li><Link href="/gallery" className="text-gray-200 font-medium hover:text-[#ffb400] duration-500 transition">Gallery</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className="text-white flex gap-3 items-center cursor-pointer  hover:text-[#ffb400] duration-500 transition">
                        <MdOutlineEditLocation className="w-7 h-7" />
                        Tabaka, Kisii County, Ngong Town, Nairobi County
                    </p>
                    <p className="text-white mt-2 flex gap-3 items-center cursor-pointer  hover:text-[#ffb400] duration-500 transition">
